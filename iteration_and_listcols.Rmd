...
Different stuff w/ different lengths -> error in making dataframe
...
l = 
  list(
    vec_numeric = 1:5,
    vec_char = LETTERS,
    matrx = matrix(1:10, nrow = 5, ncol = 2),
    summary = summary(rnorm(100))
  )
```

Accessing lists, many ways to call things out
```{r}
l$vec_char
l[[2]]
l[["summary"]]
...
Function we wnat to apply to all in the list
...
```{r}
nsduh_import <- function(html, table_num, output) {
  table = 
    html |> 
    html_table() |> 
    nth(table_num) |>
